...
(() => {
  ...
  function hasInlineTrackingConfig(scriptTag) {
    return scriptTag.getAttribute("data-config-mode") === "inline" || // Snippets generated by this fork before data-config-mode was introduced
